...
class TransactionController extends Controller
{
    ...
    {
        return view('sales.transaction.index')->with([
            'sb' => 'Transaction'
        ]);
    }
    ...
    public function getall(Request $request)
    {
        ...
        ->join('users', 'transactions.user_id', '=', 'users.id')->orderBy('id', 'desc')->where('user_id', auth()->user()->id);
        ...
        return DataTables::of($query)
            ...
            ->addColumn('action', function ($transaction) {
                return '<a href="' . url('sales/transactions/show/'. $transaction->id) . '" class="btn btn-sm btn-primary">Detail</a>';
            })
    ...
    public function show($id)
    {
        ...
        return view('sales.transaction.show', compact('transaction'))->with('sb', 'Transaction');
    }
    ...
    public function print(Request $request)
    {
        ...
        $transactions = $query->orderBy('id', 'desc')->where('user_id', auth()->user()->id)->get();

        return view('sales.transaction.print', compact('transactions'));
    }
}