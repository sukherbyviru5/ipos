@extends('master')
@section('title', 'Data Buku - Tambah')
@section('content')
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Tambah Data Buku</div>
                </div>
            </div>
            ...
            <div class="section-body">
                ...
                @endif
                <div class="card">
                    <form class="needs-validation" id="form" method="POST" action="{{ url('admin/data-buku/store') }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="id_ddc" class="form-control select2" required>
                                        ...
                                        @foreach ($ddcs as $ddc)
                                            <option value="{{ $ddc->id }}">- {{ $ddc->nama_klasifikasi }} -</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-9">
                                    <select name="id_kategori" class="form-control select2" required>
                                        ...
                                        @foreach ($kategoris as $kategori)
                                            <option value="{{ $kategori->id }}">- {{$kategori->no_urut. ' - ' . $kategori->nama_kategori }} -</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-9">
                                    <select name="id_kondisi" class="form-control select2" required>
                                        ...
                                        @foreach ($kondisis as $kondisi)
                                            <option value="{{ $kondisi->id }}">- {{ $kondisi->nama_kondisi ?? $kondisi->id }} -</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="singkatan_buku" class="form-control" placeholder="Masukkan Singkatan Buku">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="penulis_buku" class="form-control" placeholder="Masukkan Penulis Buku">
                                    @error('penulis_buku')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="penerbit_buku" class="form-control" placeholder="Masukkan Penerbit Buku">
                                    @error('penerbit_buku')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="tempat_terbit" class="form-control" placeholder="Masukkan Tempat Terbit">
                                    @error('tempat_terbit')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="tahun_terbit" class="form-control" placeholder="Masukkan Tahun Terbit">
                                    @error('tahun_terbit')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="asal_buku" class="form-control" placeholder="Masukkan Asal Buku (Contoh: Indonesia, Luar Negeri)">
                                    @error('asal_buku')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="sinopsis" class="form-control" placeholder="Masukkan Sinopsis Buku"></textarea>
                                    @error('sinopsis')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="harga_buku" class="form-control" placeholder="Masukkan Harga Buku" step="0.01">
                                    @error('harga_buku')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="lokasi_lemari" class="form-control" placeholder="Masukkan Lokasi Lemari">
                                    @error('lokasi_lemari')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
