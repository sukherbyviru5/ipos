                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                @if ($buku->cover_buku)
                                    <img src="{{ asset($buku->cover_buku) }}" alt="Cover Buku" class="img-fluid mb-3"
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Harga Buku</th>
                                                <td>{{ $buku->harga_buku ? 'Rp ' . number_format($buku->harga_buku, 0, ',', '.') : 'N/A' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Stok Buku</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($buku->ebook_file && $buku->ebook_tersedia)
                                                        <a href="{{ asset($buku->ebook_file) }}" target="_blank">Lihat
                                                            E-Book</a>
                                                    @else
                                                        Tidak tersedia
                                                    @endif
