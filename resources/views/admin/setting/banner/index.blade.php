@extends('master')
@section('title', 'Banner - Pengaturan')
@section('content')
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">Daftar Banner</h2>
                <p class="section-lead">Berikut adalah daftar banner yang tersedia.</p>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-header-form">
                            <a href="#" data-toggle="modal" data-target="#addModal" type="button"
                                class="btn btn-primary btn-sm">Tambah Banner</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table table-striped mt-5" id="bannerTable">
                            <thead>
                                <tr>
                                    <th width="10px">#</th>
                                    <th>Foto</th>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ url('admin/setting/banner') }}" method="POST" class="needs-validation" novalidate=""
    ...
    <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ url('admin/setting/banner/update') }}" method="POST" class="needs-validation" novalidate=""
                    enctype="multipart/form-data">
                    @csrf
    ...
    <script>
        ...
        $('#bannerTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ url('admin/setting/banner/all') }}",
                type: "GET"
            },
            columns: [
                { data: 'DT_RowIndex', name: 'DT_RowIndex' },
                {
                    ...
                    render: function(data) {
                        return `<img src="{{ url('/') }}/${data}" alt="Banner" style="max-width: 100px;">`;
                    }
                },
        ...
        $(document).ready(function() {
            $('#bannerTable').on('click', '.edit[data-id]', function(e) {
                e.preventDefault();
                $.ajax({
                    data: {
                        'id': $(this).data('id'),
                    ...
                    type: 'POST',
                    url: "{{ url('admin/setting/banner/get') }}",
            ...
            $('#bannerTable').on('click', '.hapus[data-id]', function(e) {
                e.preventDefault();
                swal({
                    title: "Hapus Banner ?",
                    text: "Banner akan dihapus secara permanent.",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
