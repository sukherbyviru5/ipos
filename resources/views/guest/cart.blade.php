                                ...
                                <div class="col-span-12 xl:col-span-4 bg-gray-50 p-6 rounded-lg">
                                    ...
                                    <form id="checkout-form" class="mt-6">
                                            ...
                                            <div class="mt-3">
                                                <label class="flex items-center mb-2">
                                                    <input id="pickup-radio" type="radio" value="pickup"
                                                        name="delivery_type" class="w-4 h-4 text-indigo-600" checked>
                                                    <span class="ml-2 text-sm">Pickup</span>
                                                </label>
                                                <label class="flex items-center">
                                                    <input id="delivery-radio" type="radio" value="delivery"
                                                        name="delivery_type" class="w-4 h-4 text-indigo-600">
                                        ...
                                        <div id="delivery-notes" class="hidden mt-4">
                                            <label for="delivery_desc" class="block text-sm font-medium text-gray-700">
                                                Catatan Pengiriman
                                            </label>
                                            <textarea name="delivery_desc" id="delivery_desc" rows="3" class="mt-1 w-full border rounded-lg p-2 text-sm"
                                                placeholder="Isi dengan nama, alamat dan lainnya"></textarea>
                                        </div>

                                        <div class="flex items-center justify-between py-6 border-t mt-6">
                                            <p id="cart-summary-count" class="font-medium text-lg">0 Item</p>
                                            <p id="cart-summary-total" class="font-semibold text-xl text-indigo-600">Rp. 0
                                            </p>
                                        </div>

                                        <button type="submit"
                                            class="w-full text-center bg-indigo-600 rounded-xl py-3 px-6 font-semibold text-lg text-white transition hover:bg-indigo-700">
                                            Bayar Sekarang
                                        </button>
                                    </form>
                                </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function renderProducts(products) {
                ...
                products.forEach(product => {
                    ...
                    item.innerHTML = `
                <div class="w-28">
                    <img src="${product.photos?.[0]?.foto ? '/' + product.photos[0].foto : '/assets/img/human.png'}"
            ...
            function updateSummary() {
                ...
                document.querySelectorAll(".qty-input").forEach(input => {
                    ...
                    let subtotal = document.querySelector(`.subtotal[data-id="${input.dataset.id}"]`)
                        .textContent;
                ...
                summaryTotal.textContent = formatCurrency(totalHarga);
            }
