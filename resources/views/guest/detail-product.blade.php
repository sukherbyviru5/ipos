                        ...
                        @if ($product)
                            <div class="bg-white">
                                <div class="">
                                        ...
                                        <ol role="list"
                                            ...
                                            <li>
                                                <div class="flex items-center">
                                                    <a href="{{ route('home') }}"
                                                        class="mr-2 text-sm font-medium text-gray-900">LUNARAY</a>
                                    ...
                                    <!-- Image gallery -->
                                    <div
                                        class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-8 lg:px-8 overflow-x-auto">
                                        @if ($product->photos->isEmpty())
                                            <img src="{{ asset('assets/img/human.png') }}" alt="{{ $product->name }}"
                                                class="row-span-2 aspect-3/4 mb-2 size-full rounded-lg object-cover" />
                                        ...
                                        @else
                                            @foreach ($product->photos as $photo)
                                                <img src="{{ asset($photo->foto) }}" alt="{{ $product->name }}"
                                                    class="row-span-2 aspect-3/4 mb-2 size-full rounded-lg object-cover" />
                                            @endforeach
                                        @endif
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="mt-4 lg:row-span-3 lg:mt-0">
                                            ...
                                            <p class="text-2xl tracking-tight text-gray-900">Rp.
                                            ...
                                            <form class="mt-5" id="checkout-form">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mt-4">
                                                        <div class="flex items-center mb-4">
                                                            <input id="pickup-radio" type="radio" value="pickup"
                                                                name="delivery_type"
                                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500"
                                                                checked>
                                                            <label for="pickup-radio"
                                                                class="ms-2 text-sm font-medium text-gray-900">Pickup</label>
                                                        </div>
                                                        <div class="flex items-center">
                                                            <input id="delivery-radio" type="radio" value="delivery"
                                                                name="delivery_type"
                                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                                                            <label for="delivery-radio"
                                                                class="ms-2 text-sm font-medium text-gray-900">Delivery</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="delivery-notes" class="mt-4 hidden">
                                                    <label for="delivery_desc"
                                                        class="text-sm font-medium text-gray-900">Catatan
                                                        Pengiriman</label>
                                                    <textarea id="delivery_desc" name="delivery_desc" rows="4"
                                                        class="mt-2 text-sm w-full rounded-md border p-2 focus:border-indigo-500 focus:ring-indigo-500"
                                                        placeholder="Isi dengan nama, alamat dan lainnya"></textarea>
                                                </div>
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <div class="mt-4 flex items-center space-x-2">
                                                        <button type="button" id="decrease-quantity"
                                                            class="h-10 w-10 flex items-center justify-center rounded-full border border-gray-400 text-gray-600 hover:bg-gray-100 hover:text-gray-800 transition">
                                                            -
                                                        </button>
                                                        <input type="number" id="quantity" name="quantity" value="1"
                                                            min="1" max="{{ $product->stock }}"
                                                            class="w-28 h-10 rounded-lg border border-gray-300 text-center text-base font-medium focus:border-indigo-400 focus:ring-indigo-400">
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <p class="text-xl font-semibold text-gray-900" id="total-price">Rp.
                                                        {{ number_format($product->price) }}</p>
                                                </div>

                                                @if (auth()->user())
                                                      <button type="submit" id="pay-button"
                                                    class="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden">Bayar
                                                    Sekarang <i class="ms-2 fa-solid fa-comments-dollar"></i></button>
                                                @else
                                                      <a href="{{ route('login') }}" 
                                                    class="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden">  <i class="fa-solid fa-right-to-bracket mr-2 transition-transform group-hover:translate-x-1"></i> Login / Masuk</a>
                                                @endif
                                        ...
                                        <div
                                            class="py-5 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pt-6 lg:pr-8 lg:pb-16">
                                            <div class="mt-3">
                                                <h3 class="text-sm font-medium text-gray-900">Informasi Produk</h3>
                                                <div class="mt-4">
                                                    <ul role="list" class="list-disc space-y-2 pl-4 text-sm">
                                                        <li class="text-gray-400"><span class="text-gray-600">Neto:
                                                                {{ $product->neto ? $product->neto . ' / ' : '-' }}
                                                                {{ $product->pieces }}</span></li>
                                                        <li class="text-gray-400">
                                                            @if ($product->stock > 0)
                                                                <span class="text-gray-600">Stok:
                                                                    {{ $product->stock }}</span>
                                                            @else
                                                                <span class="text-red-500 italic">Stok Habis</span>
                                                            @endif
                                                        </li>
                                                        <li class="text-gray-400"><span class="text-gray-600">Merk:
                                            ...
                                            <div class="mt-10">
                                                ...
                                                <div class="mt-4 space-y-6">
                                                    <p class="text-sm text-gray-600">
                                                        {{ $product->description ?? ($product->category->description ?? 'Detail produk untuk ' . $product->name . ' dari kategori ' . $product->category->name . '.') }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            @else
                                <div
                                    class="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-white/80 py-24 text-center">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Kami tidak dapat menemukan produk yang cocok
