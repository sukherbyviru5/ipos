                            ...
                            @foreach ($artikels as $index => $artikel)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('siswa.publikasi.delete', $artikel->id) }}" method="POST"
    ...
    <div class="modal fade" id="addArtikelModal" tabindex="-1" aria-labelledby="addArtikelModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('siswa.publikasi.store') }}" method="POST" enctype="multipart/form-data"
                    id="addArtikelForm">
                    @csrf
...
@section('scripts')
    <script>
        function populateEditModal(button) {
            ...
            form.action = `/siswa/publikasi/${id}`;
